...
import com.chicorski.chicofoodapi.api.v1.openapi.model.FormasPagamentoModelOpenApi;
...
public interface FormaPagamentoControllerOpenApi {
    ...
    ResponseEntity<FormaPagamentoModel> buscar(@ApiParam(value = "ID de uma forma de pagamento", example = "1", required = true) Long id,
    ...
    FormaPagamentoModel adicionar(@ApiParam(name = "corpo", value = "Representação de uma forma de pagamento.", example = "1", required = true) FormaPagamentoInput formaPagamentoInput);
    ...
    FormaPagamentoModel atualizar(@ApiParam(value = "ID de uma forma de pagamento", example = "1", required = true) Long id,
                                  @ApiParam(name = "corpo", value = "Representação de uma forma de pagamento com os novos dados.", example = "1", required = true) FormaPagamentoInput formaPagamentoInput);
