...
create table usuario (id bigint not null, data_cadastro dateTime not null, email varchar(255) not null, nome varchar(255) not null, senha varchar(255) not null, primary key (id)) engine=InnoDB
...
insert into cozinha (id, nome) values (1, 'Tailadensa')
